...
public class DriverRaceResultController {
    ...
    @PutMapping("/driverraceresults/{id}")
    ...
    @Transactional
    @PatchMapping("/driverraceresults/{id}") //zmiana
